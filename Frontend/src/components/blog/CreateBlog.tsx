...
export default function CreateBlog({
    ...
    const handleAIAddContent = (title: string, description: string) => {
    ...
    return (
        <>
            <div className="fixed inset-0 overflow-y-auto bg-black/50 flex items-start justify-center">
                <div className="min-h-screen w-full py-4 px-2">
                    <form onSubmit={handleSubmit}>
                        <Card className="w-full max-w-5xl  mx-auto my-8">
                            <CardHeader className="sticky top-0 z-10 flex justify-between items-center bg-[#1a1a1a] p-4">
                            ...
                            <CardBody className="gap-4 w-full">
                                <div className='flex flex-col md:grid md:grid-cols-2 gap-4'>
                                    ...
                                    <div className='order-last md:order-none flex items-center justify-center h-full'>
                                        <div className="w-[300px] h-[300px] flex items-center justify-center ">

                                            {Array(1).fill(null).map((_, index) => (
                                                <motion.div
                                                    key={index}
                                                    className="relative aspect-square cursor-pointer w-full h-full"
...

            {
                isModalOpen && (
                    <AIModal
                        ...
                        onAddContent={handleAIAddContent}
